        ...
        <div class="row">
            ...
            <div class="col-md-6 text-md-end">
                <p class="mb-0">
                    ...
                    <?= date('Y') ?> - Desenvolvido por: Lidera Tecnologia e Gestão - Todos os direitos reservados
                </p>
            </div>
        </div>
    </div>
...
// Inicializar DataTables e outros eventos
$(document).ready(function() {
    ...
    // Auto-hide alerts after 5 seconds, exceto na página de consulta de local
    if (!window.location.pathname.includes('consulta_local.php')) {
        setTimeout(function() {
