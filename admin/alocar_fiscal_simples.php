...
$pageTitle = 'Alocar Fiscal (Versão Simples)';
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <?php 
                                ...
                                echo "<tr><td colspan='6' class='text-center'>Nenhuma alocação encontrada</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
